...
class CategoriaController extends Controller
{
    ...
    {
        /*/consulta que regresa todo lo que se encuentra en categorias*/
    ...
    public function store(Request $request)
    {
        ...
        $categoria->save();
        return redirect()->route('categorias.index')->with('success', 'Agregado con éxito!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $categorias->save();
        return redirect()->route('categorias.index')->with('success', 'Actualizado con éxito!');
    }
    ...
    public function destroy($id)
    {
        $categorias = Categoria::find($id);
        $categorias->delete();
        return redirect()->route('categorias.index')->with('success', 'destroy con éxito!');
    }
}
